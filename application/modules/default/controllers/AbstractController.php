<?php
class AbstractController extends Zend_Rest_Controller
{
   ...
   public function indexAction()
   {
        ...
        $this->dispachResponse($this->_response_type, $arrValues);
   }
...
*/
    ...
    */
    public function guardData($fields)
    {
        ...
        $fieldKeys = $this->_model->getFieldKey();
        $is_array = is_array($fields);
        $data = array();

        foreach($fieldNames as $field)
            $data[$field] = urldecode(($is_array ? $fields[$field] : $fields->$field ));
        ...
        else
        {
            ...
            foreach ($fieldNames as $fieldName)
            {
                ...
                $fieldValue = utf8_decode($form->$fieldName->getValue());
